...
作成日: 2026-08-01（初版）／改訂: 2026-08-01（第1章・第2章25問承認版）
対象: G検定学習・演習アプリ スクラッチ開発
ステータス: 技術方針・データ方針、第1章25問・第2章25問（いずれも`reviewStatus: approved`）は承認済み。第3章以降は本書16節・17.7節の運用方針（2章ずつのバッチ、重点レビュー方式、20項目の自動品質ゲート、原則25問個別レビューなし）で進める。
